...
`docs/decisions.md` AD-26 for the full writeup.
...
- `supabase/migrations/20260704000004_ranking_overall_score.sql` (new)
...
- `scripts/score.ts`
- Docs: `design/architecture.md`, `design/erd.md`, `design/scope.md`, `design/use-cases.md`, `design/api-reference.md`, `design/user-guide.md`, `design/limitations.md`, `design/tech-stack.md` (none — no new env var), `docs/decisions.md` (AD-26)
