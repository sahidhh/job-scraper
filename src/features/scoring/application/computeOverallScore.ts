...
type RankableJob = Pick<Job, "canonicalCompanyName" | "locationTags" | "salaryMin" | "salaryMax">;
 ...
 * prefers remote, and salary being disclosed at all (an information
 * advantage, not a judgement of whether the number is "good"). Deliberately
 * not ML/embeddings-based -- see design/decisions.md.
 *
